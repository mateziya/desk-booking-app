...
<body class="font-Montserrat bg-gray-950 relative isolate">
    @inertia
    ...
    <div class=" inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
        aria-hidden="true">
