              ...
              <tbody>
                <tr v-for="user in users" :key="user.id">
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-xs capitalize">
                    <span v-if="user.role === 'admin'" class="hidden place-content-center max-w-16 rounded-md bg-red-50/5 px-2 py-1 font-medium text-red-500 ring-1 ring-inset ring-red-600/20 sm:table-cell">{{ user.role }}</span>
                    <span v-if="user.role === 'user'" class="hidden place-content-center max-w-16 rounded-md bg-green-50/5 px-2 py-1 font-medium text-green-500 ring-1 ring-inset ring-green-600/20 sm:table-cell">{{ user.role }}</span>
                  </td>
